...
const BUILD = /* fuggetlenfe */ { hotModuleReplacement: false, hydratedSelectorName: "hydrated", prop: true, propChangeCallback: false, slotRelocation: true, updatable: true};
...
class FfButton {
    ...
    render() {
         ...
         */
        return (hAsync(Host, { key: '27e7447be2f779090838a84cb1fae4b374a076e3', class: {
                'ff-button-host': true,
                'ff-button-host--full-width': this.fullWidth
            } }, hAsync("button", { key: '763ded39849a7f33714eea00ab3ba9e35dfecf11', class: "ff-button", disabled: this.disabled, part: "button", type: this.type, "aria-label": this.ffAriaLabel, onClick: this.handleClick }, hAsync("slot", { key: '90cab54f87e0086b6e9706c870b07e98fb0f9601' }, this.label))));
    }
