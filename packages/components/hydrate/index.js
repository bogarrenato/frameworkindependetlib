...
const NAMESPACE = 'fuggetlenfe';
const BUILD = /* fuggetlenfe */ { hotModuleReplacement: false, hydratedSelectorName: "hydrated", slotRelocation: true, state: true, updatable: true};
...
const ffButtonCss = () => `:host{display:inline-flex;--_button-bg:var(--ff-button-bg-default, transparent);--_button-fg:var(--ff-button-fg-default, inherit)}:host(.ff-button-host--full-width){display:flex;width:100%}.ff-button{display:inline-flex;align-items:center;justify-content:center;width:100%;min-height:22px;border:0;border-radius:var(--ff-button-radius, 0px);background:var(--_button-bg);color:var(--_button-fg);cursor:pointer;font-family:var(--ff-font-family-brand, inherit);font-size:16px;font-weight:400;line-height:1.4;padding:var(--ff-button-padding-block, 0px) var(--ff-button-padding-inline, 0px);text-align:center;transition:background-color 160ms ease,     color 160ms ease,     transform 120ms ease,     box-shadow 160ms ease}.ff-button:hover:not(:disabled){--_button-bg:var(--ff-button-bg-hover, var(--ff-button-bg-default, transparent));--_button-fg:var(--ff-button-fg-hover, var(--ff-button-fg-default, inherit))}.ff-button:active:not(:disabled){--_button-bg:var(--ff-button-bg-active, var(--ff-button-bg-default, transparent));--_button-fg:var(--ff-button-fg-active, var(--ff-button-fg-default, inherit));transform:translateY(1px)}.ff-button:focus-visible{outline:2px solid color-mix(in srgb, var(--ff-color-text-primary, currentColor) 28%, transparent);outline-offset:2px}.ff-button:disabled{--_button-bg:var(--ff-button-bg-disabled, transparent);--_button-fg:var(--ff-button-fg-disabled, inherit);cursor:not-allowed;opacity:1}`;
...
class FfButton {
    constructor(hostRef) {
        ...
        this.ffClick = createEvent(this, "ffClick");
    ...
    async setFocus() {
        ...
        const button = this.host.shadowRoot?.querySelector('button[part="button"]');
        button?.focus();
    }
    render() {
        /*
         ...
         */
        return (hAsync(Host, { key: 'e3cd5ae84d349751b1bb74d7154475044c156600', class: {
                'ff-button-host': true,
                'ff-button-host--full-width': this.fullWidth
            } }, hAsync("button", { key: '26284e6a489b26ee6e9c9e371a8ea8b7e713dae0', class: "ff-button", disabled: this.disabled, part: "button", type: this.type, "aria-label": this.ffAriaLabel, onClick: this.handleClick }, hAsync("slot", { key: '11f5962dc150b60c100b3a1c7f1f13aa26c009f5' }, this.label))));
    }
    static get delegatesFocus() { return true; }
    get host() { return getElement(this); }
    static get style() { return ffButtonCss(); }
    static get cmpMeta() { return {
        ...
        "$members$": {
            ...
            "variant": [513],
            "label": [1],
            "ffAriaLabel": [1, "ff-aria-label"],
            "setFocus": [64]
        },
        "$listeners$": undefined,
        "$lazyBundleId$": "-",
        "$attrsToReflect$": [["disabled", "disabled"], ["type", "type"], ["fullWidth", "full-width"], ["variant", "variant"]]
    }; }
}

const ffDataTableCss = () => `:host{display:block;width:100%;font-family:var(--ff-font-family-brand, inherit);color:var(--ff-data-table-text, var(--ff-color-text-primary, inherit))}.ff-data-table{display:block;width:100%;background:var(--ff-data-table-bg, transparent);border-radius:var(--ff-data-table-radius, 8px);overflow:hidden;border:1px solid var(--ff-data-table-row-border, color-mix(in srgb, currentColor 18%, transparent))}.ff-data-table__row{display:grid;grid-template-columns:var(--ff-dt-grid-template, 1fr);gap:0;border-bottom:1px solid     var(--ff-data-table-row-border, color-mix(in srgb, currentColor 10%, transparent));transition:background-color 140ms ease}.ff-data-table__row:last-child{border-bottom:0}.ff-data-table__row--header{background:var(--ff-data-table-header-bg, color-mix(in srgb, currentColor 8%, transparent));color:var(--ff-data-table-header-fg, inherit);font-weight:600;border-bottom:1px solid     var(--ff-data-table-row-border, color-mix(in srgb, currentColor 18%, transparent))}.ff-data-table__row--selectable{cursor:pointer}.ff-data-table__row--selectable:hover{background:var(--ff-data-table-row-hover-bg, color-mix(in srgb, currentColor 5%, transparent))}.ff-data-table__row--selected{background:var(--ff-data-table-row-selected-bg, color-mix(in srgb, currentColor 12%, transparent))}.ff-data-table__cell{padding:0.75rem 0.9rem;display:flex;align-items:center;gap:0.4rem;min-width:0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.ff-data-table__cell--align-center{justify-content:center;text-align:center}.ff-data-table__cell--align-end{justify-content:flex-end;text-align:right}.ff-data-table__cell--header{font-size:0.8125rem;letter-spacing:0.02em;text-transform:uppercase;user-select:none}.ff-data-table__cell--sortable{cursor:pointer}.ff-data-table__cell--sortable:focus-visible{outline:2px solid color-mix(in srgb, var(--ff-color-text-primary, currentColor) 28%, transparent);outline-offset:-2px}.ff-data-table__sort-indicator{font-size:0.65em;opacity:0.7}.ff-data-table__empty{display:grid;grid-template-columns:1fr;padding:2rem 1rem;text-align:center;color:color-mix(in srgb, currentColor 55%, transparent)}.ff-data-table__cell--empty{justify-content:center}`;

class FfDataTable {
    constructor(hostRef) {
        registerInstance(this, hostRef);
        this.ffSortChange = createEvent(this, "ffSortChange");
        this.ffSelectionChange = createEvent(this, "ffSelectionChange");
        ...
        this.emptyLabel = 'No data to display.';
        ...
        this.handleRowSelect = (row) => (event) => {
    ...
    syncSelectionFromProp() {
        const parsed = this.parseList(this.selectedIds);
    ...
    get parsedColumns() {
        return this.parseList(this.columns);
    }
    get parsedRows() {
        return this.parseList(this.rows);
    }
    get displayRows() {
    ...
    render() {
        ...
        return (hAsync(Host, { key: '0c1ce92c1a27a839d29381ee1fabbf7625f27f54', class: "ff-data-table-host", role: "table", "aria-label": this.ffCaption }, hAsync("div", { key: 'd9d661c7293feac55825140b6423b546e0ef4f05', class: "ff-data-table", part: "table", style: { '--ff-dt-grid-template': gridTemplate } }, hAsync("div", { key: '913ca3750f7270290d234401cb063da4e98b1758', class: "ff-data-table__header", role: "rowgroup", part: "header" }, hAsync("div", { key: '389a37cad95ca1b72a230c430d8f298f850dc19d', class: "ff-data-table__row ff-data-table__row--header", role: "row" }, columns.map((column) => {
            ...
            return (hAsync("div", { class: {
                    ...
                    'ff-data-table__cell--sortable': this.sortable && column.sortable !== false,
                    'ff-data-table__cell--active-sort': active
                }, role: "columnheader", "aria-sort": active
                    ? this.sortDirection === 'asc'
                        ? 'ascending'
                        : 'descending'
                    : 'none', onClick: this.handleSort(column) }, hAsync("span", null, column.label), active ? (hAsync("span", { class: "ff-data-table__sort-indicator", "aria-hidden": "true" }, this.sortDirection === 'asc' ? '▲' : '▼')) : null));
        }))), hAsync("div", { key: 'c2f93d3764942694967dc8e25a08862001754fe0', class: "ff-data-table__body", role: "rowgroup", part: "body" }, rows.length === 0 ? (hAsync("div", { class: "ff-data-table__empty", role: "row" }, hAsync("div", { class: "ff-data-table__cell ff-data-table__cell--empty", role: "cell" }, this.emptyLabel))) : (rows.map((row) => {
            ...
            return (hAsync("div", { class: {
                ...
                }, role: "row", "aria-selected": selected ? 'true' : undefined, onClick: this.handleRowSelect(row) }, columns.map((column) => (hAsync("div", { class: {
                    'ff-data-table__cell': true,
                    [`ff-data-table__cell--align-${column.align ?? 'start'}`]: true
                }, role: "cell" }, this.renderCellValue(row[column.key]))))));
        }))))));
    }
    ...
    static get style() { return ffDataTableCss(); }
    static get cmpMeta() { return {
        "$flags$": 9,
        ...
        "$members$": {
            ...
            "rows": [1],
            "sortable": [4],
            "sortKey": [1025, "sort-key"],
            "sortDirection": [1025, "sort-direction"],
            "selectionMode": [1, "selection-mode"],
            "selectedIds": [1025, "selected-ids"],
            "emptyLabel": [1, "empty-label"],
            "ffCaption": [1, "ff-caption"],
            "internalSelection": [32]
        },
        "$listeners$": undefined,
        "$lazyBundleId$": "-",
        "$attrsToReflect$": []
...
const ffDropdownCss = () => `:host{display:inline-block;position:relative;font-family:var(--ff-font-family-brand, inherit);--_dd-bg:var(--ff-dropdown-bg, transparent);--_dd-fg:var(--ff-dropdown-fg, currentColor);--_dd-border:var(--ff-dropdown-border, currentColor);--_dd-radius:var(--ff-dropdown-radius, var(--ff-button-radius, 6px))}:host([disabled]){opacity:0.55;pointer-events:none}.ff-dropdown__trigger{display:inline-flex;align-items:center;justify-content:space-between;gap:0.75rem;min-width:220px;padding:0.55rem 0.85rem;border-radius:var(--_dd-radius);border:1px solid var(--_dd-border);background:var(--_dd-bg);color:var(--_dd-fg);font:inherit;cursor:pointer;transition:border-color 160ms ease, background-color 160ms ease}.ff-dropdown__trigger:focus-visible{outline:2px solid color-mix(in srgb, var(--ff-color-text-primary, currentColor) 30%, transparent);outline-offset:2px}.ff-dropdown__value{text-align:left;flex:1}.ff-dropdown__caret{font-size:0.75em;opacity:0.7;transition:transform 160ms ease}:host(.ff-dropdown-host--open) .ff-dropdown__caret{transform:rotate(180deg)}.ff-dropdown__menu{position:absolute;top:calc(100% + 4px);left:0;right:0;margin:0;padding:4px;list-style:none;background:var(--ff-dropdown-menu-bg, var(--ff-color-surface, #fff));color:var(--_dd-fg);border:1px solid var(--_dd-border);border-radius:var(--_dd-radius);box-shadow:0 12px 32px color-mix(in srgb, currentColor 18%, transparent);z-index:20;max-height:280px;overflow-y:auto;display:none}:host(.ff-dropdown-host--open) .ff-dropdown__menu{display:block}.ff-dropdown__option{padding:0.5rem 0.75rem;border-radius:calc(var(--_dd-radius) - 2px);cursor:pointer;user-select:none}.ff-dropdown__option--highlighted{background:var(--ff-dropdown-option-hover-bg, color-mix(in srgb, currentColor 10%, transparent))}.ff-dropdown__option--selected{background:var(--ff-dropdown-option-selected-bg, color-mix(in srgb, currentColor 16%, transparent));font-weight:600}.ff-dropdown__option--disabled{opacity:0.5;cursor:not-allowed}`;

class FfDropdown {
    constructor(hostRef) {
        registerInstance(this, hostRef);
        this.ffChange = createEvent(this, "ffChange");
        this.ffOpenChange = createEvent(this, "ffOpenChange");
    ...
    render() {
        ...
        return (hAsync(Host, { key: 'a15a65bf5560f8ff4b1c5fa90851dc2e289ccc17', class: { 'ff-dropdown-host': true, 'ff-dropdown-host--open': this.open } }, hAsync("button", { key: '98c2a5cf7619d605b0cf3a5c0701f7d3b9192de8', type: "button", class: "ff-dropdown__trigger", part: "trigger", "aria-haspopup": "listbox", "aria-expanded": this.open ? 'true' : 'false', "aria-label": this.ffAriaLabel, disabled: this.disabled, onClick: this.handleTriggerClick }, hAsync("span", { key: '6ed09a3dbb1846a6d9e2268bd9d3c6c8416aa809', class: "ff-dropdown__value" }, selected ? selected.label : this.placeholder), hAsync("span", { key: 'b849e7b2ac768f033196f1aebb7cd00d5a948035', class: "ff-dropdown__caret", "aria-hidden": "true" }, "\u25BE")), hAsync("ul", { key: 'd986f2e0bd25afdfa78f54c02ca3e1a1b2262f13', class: "ff-dropdown__menu", part: "listbox", role: "listbox", "aria-hidden": this.open ? 'false' : 'true', tabIndex: -1 }, opts.map((option, index) => (hAsync("li", { class: {
            ...
            }, role: "option", "aria-selected": option.value === this.value ? 'true' : 'false', "aria-disabled": option.disabled ? 'true' : 'false', part: "option", onClick: this.handleOptionClick(option), onMouseEnter: () => (this.highlightedIndex = index) }, option.label))))));
    }
    get host() { return getElement(this); }
    static get watchers() { return {
        "open": [{
    ...
    static get style() { return ffDropdownCss(); }
    static get cmpMeta() { return {
        "$flags$": 9,
        "$tagName$": "ff-dropdown",
        "$members$": {
        ...
        "$listeners$": undefined,
        "$lazyBundleId$": "-",
        "$attrsToReflect$": [["disabled", "disabled"], ["open", "open"]]
    }; }
}

const ffModalCss = () => `:host{display:contents;font-family:var(--ff-font-family-brand, inherit)}.ff-modal__backdrop{position:fixed;inset:0;display:none;align-items:center;justify-content:center;padding:1.5rem;background:var(--ff-modal-backdrop, color-mix(in srgb, black 55%, transparent));z-index:1000}:host(.ff-modal-host--open) .ff-modal__backdrop{display:flex}.ff-modal__surface{width:min(560px, 100%);max-height:90vh;overflow:auto;background:var(--ff-modal-surface, var(--ff-color-surface, #fff));color:var(--ff-modal-body-color, var(--ff-color-text-primary, inherit));border-radius:var(--ff-modal-radius, 12px);box-shadow:var(--ff-modal-shadow, 0 24px 64px color-mix(in srgb, black 30%, transparent));display:flex;flex-direction:column}.ff-modal__header{display:flex;align-items:center;justify-content:space-between;gap:1rem;padding:1.25rem 1.5rem 0.75rem}.ff-modal__title{margin:0;font-size:1.125rem;font-weight:600;color:var(--ff-modal-title-color, inherit)}.ff-modal__close{background:transparent;border:0;color:inherit;font-size:1.5rem;line-height:1;cursor:pointer;padding:0.25rem 0.5rem;border-radius:6px}.ff-modal__close:focus-visible{outline:2px solid color-mix(in srgb, var(--ff-color-text-primary, currentColor) 30%, transparent);outline-offset:2px}.ff-modal__body{padding:0.5rem 1.5rem 1.25rem;line-height:1.55}.ff-modal__footer{display:flex;justify-content:flex-end;gap:0.5rem;padding:0.75rem 1.5rem 1.25rem}.ff-modal__footer:empty{display:none}`;
...
class FfModal {
    constructor(hostRef) {
        registerInstance(this, hostRef);
        this.ffClose = createEvent(this, "ffClose");
    ...
    getFocusables() {
        ...
        const closeButton = shadowRoot.querySelector('.ff-modal__close');
        ...
        const slotted = Array.from(this.host.querySelectorAll(slottedQuery));
        /*
    ...
    hostHoldsActive(host, active) {
        if (!active)
            return false;
        if (host === active)
            return true;
        const hostShadow = host
            .shadowRoot;
    ...
    render() {
        return (hAsync(Host, { key: '63ce4b10b80a7f9485b2e77e710aa5c197403cc7', class: { 'ff-modal-host': true, 'ff-modal-host--open': this.open }, "aria-hidden": this.open ? 'false' : 'true' }, hAsync("div", { key: 'bcb889f54e9719ab4df38da3bf0d76eb6a116876', class: "ff-modal__backdrop", part: "backdrop", onClick: this.handleBackdropClick }, hAsync("div", { key: 'bfb2ce1ca92ea422c38600213b2fad6cfa6486ec', class: "ff-modal__surface", part: "surface", role: "dialog", "aria-modal": "true", "aria-labelledby": "ff-modal-title", "aria-describedby": this.ariaDescribedbyId }, hAsync("header", { key: 'acb1db2fee56d284d8fca4fe7f959b68355661f8', class: "ff-modal__header", part: "header" }, hAsync("h2", { key: 'cdc688d38730817edbeab6809c897c5b831584a9', id: "ff-modal-title", class: "ff-modal__title" }, hAsync("slot", { key: '25bb95d68fa634842949171b5157e82354e2fe6c', name: "title" }, this.ffTitle)), hAsync("button", { key: '9afe47c0ee60c82b493bf71567aca575143e13bf', type: "button", class: "ff-modal__close", part: "close", "aria-label": "Close", onClick: () => this.requestClose() }, "\u00D7")), hAsync("section", { key: '8e632dfb6fc50603495758d93750cd23bc9b2da3', class: "ff-modal__body", part: "body" }, hAsync("slot", { key: 'ed2beff09d813fbe8487ef0ae733ae208220ade7' })), hAsync("footer", { key: '24e2cc9a5283516df5fa561bbc23e19c59560579', class: "ff-modal__footer", part: "footer" }, hAsync("slot", { key: '3e35c59357710a49567e6c3c1d0679d91bf26cb7', name: "footer" }))))));
    }
    get host() { return getElement(this); }
    static get watchers() { return {
        "open": [{
    ...
    static get style() { return ffModalCss(); }
    static get cmpMeta() { return {
        "$flags$": 265,
        "$tagName$": "ff-modal",
        "$members$": {
