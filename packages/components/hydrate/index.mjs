...
class FfButton {
    ...
    render() {
         ...
         */
        return (hAsync(Host, { key: 'ca12fb259f55e33791bf7e7e6ee7ae143393136f', class: {
                'ff-button-host': true,
                'ff-button-host--full-width': this.fullWidth
            } }, hAsync("button", { key: '58b7b766f25dfb8f251e338e0596bcf1ed38b064', class: "ff-button", disabled: this.disabled, part: "button", type: this.type, "aria-label": this.ffAriaLabel, onClick: this.handleClick }, hAsync("slot", { key: '8b96a3f670a37294467f126e17d329f4e2b895a6' }, this.label))));
    }
...
class FfModal {
    ...
    firstFocusable() {
        ...
        if (!root)
            return null;
        return root.querySelector('[data-autofocus], button, [href], input, select, textarea, [tabindex]:not([tabindex="-1"])');
    }
    trapFocus(event) {
        const root = this.host.shadowRoot;
        if (!root)
    ...
    render() {
        return (hAsync(Host, { key: '0fb2c1df7a9ad4a28e9b2620367547c15b2bbdb4', class: { 'ff-modal-host': true, 'ff-modal-host--open': this.open }, "aria-hidden": this.open ? 'false' : 'true' }, hAsync("div", { key: '996b0fcb75adbc997bca51eb0ad6a5bae6c59caf', class: "ff-modal__backdrop", part: "backdrop", onClick: this.handleBackdropClick }, hAsync("div", { key: '0bb57a0e01d1a8675681318255359a36c53317a1', class: "ff-modal__surface", part: "surface", role: "dialog", "aria-modal": "true", "aria-labelledby": "ff-modal-title", "aria-describedby": this.ariaDescribedbyId }, hAsync("header", { key: '2191ec94e91e3b68333413c2aa84138d23c2e350', class: "ff-modal__header", part: "header" }, hAsync("h2", { key: '41c267e19e628196475e40e3b591388fbeef4e94', id: "ff-modal-title", class: "ff-modal__title" }, hAsync("slot", { key: 'bee555d67a888ad55a1fa35e5af7c2cdc9f8e599', name: "title" }, this.ffTitle)), hAsync("button", { key: '7d1def9d51899d8e478d0c242385d426d958c582', type: "button", class: "ff-modal__close", part: "close", "aria-label": "Close", onClick: () => this.requestClose() }, "\u00D7")), hAsync("section", { key: 'd0853a7778ea80af54b7fbbb444d65f9ce7e8afe', class: "ff-modal__body", part: "body" }, hAsync("slot", { key: '76c41fdd8d930b064c3d4ad6259fa6031f6b151a' })), hAsync("footer", { key: 'fb54a82e08da4a2968461fb595cde6b5404e1909', class: "ff-modal__footer", part: "footer" }, hAsync("slot", { key: 'cfe70038e98d45bc236f4e15d37c2785f7fda173', name: "footer" }))))));
    }
    get host() { return getElement(this); }
    static get watchers() { return {
        "open": [{
