...
/*
  FfButton is the React wrapper for the Stencil <ff-button> web component.
  It is auto-generated by @stencil/react-output-target and contains zero styling.
  The component logic (props, slots, shadow DOM) lives in packages/components/src/components/ff-button/.
  The visual identity comes from the CSS imports in main.tsx (contract.css + brand pack).
*/
...
function App() {
  ...
  return (
    {/* data-brand and data-theme on the shell element activate the brand pack CSS.
        ...
        Every FfButton inside this shell inherits the Brand 2 visual identity automatically. */}
